...
<body>
	...
	<form:form method="POST" commandName="modelo" action="" modelattribute="AnadirUsuarioAplicacionModel" >
			<br>
	
		<div class=" jumbotron">
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
				<form:select path="usuario" class="form-control center-block"				items="${usuarios}" />
			</div>
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
				<form:select path="aplicacion" class="form-control center-block" items="${aplicaciones}" />
			</div>
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<input type="submit" value="editar" class=" btn btn-default center-block"  style="margin-top: 15px;"/>
			</div>
