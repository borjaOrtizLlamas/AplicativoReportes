...
<script src="<c:url value="/resources/js/correos.js" />" charset="UTF-8"></script>
...
<body onload="creacionSpans()">
	...
	<div class="container-fluid">
		...
		<div class="col-sm-6 col-lg-10">
			<img src="/main/resources/imagenes/connectis.jpg"
				class="img-responsive img-rounded">

		</div>
		<div class="col-sm-6 col-lg-2" id="bordeImagenes">
			<img src="/main/resources/imagenes/salud.png"
				class="img-responsive img-rounded">
		...
		<form:form method="POST" commandName="Incidencia"
			...
			enctype="multipart/form-data" modelattribute="Peticion"
			onsubmit="foo()" class="form-horizontal" role="form">
          ...
          Entorno:
			...
			<div class="col-sm-6 col-lg-3 celda columna1">
				<div class="form-group">
					<form:label path="aplicacion"
						class="col-md-4 control-label titulos">
          Aplicación:
          </form:label>
          ...
          BBDD:</form:label>
           ...
           Aplicación</form:label>
			...
			<div class="col-sm-6 col-lg-3 celda columna1">
				<div class="form-group">
					<form:label path="listaPorDefecto"
						class="col-md-4 control-label titulos">
          Autorizador:
          </form:label>

					<div class="col-md-8">
						<form:select path="listaPorDefecto" id="listaPorDefecto"
							items="${autorizadoras}" onclick="apareceAutorizante()" />
					</div>
				</div>
			</div>
			...
			<div class="col-sm-6 col-lg-4 celda2 columna1">
				<div class="form-group">
					<form:label path="radioFecha"
						class="col-md-2 control-label titulos">
         Fecha:
          </form:label>


					<div class="col-md-1">
						<form:radiobutton id="botonFecha" path="radioFecha" value="fecha"
							onclick="actualizarPicker()" />
					</div>
			...
			<div class="col-sm-6 col-lg-3 text-center celda2 columna1"
				id="altura2">
				<div class="form-group">
					<form:label path="fechaComentario"
						class="col-md-4 control-label titulos">
         Comentario:
          </form:label>
			...
			<div class="col-sm-6 col-lg-2 celda2 text-center columna1"
				id="altura2">
				<div class="form-group ">
					<div class="col-md-12">
						<form:checkbox id="botonUrgente" path="urgente" value="URGENTE"
			...
			<div class="col-sm-6 col-lg-3 celda2 columna1" id="altura2">
				<div class="form-group">
					<div class="col-md-6">
						<form:input path="autorizador" id="textUsuario"
							placeholder="Autorizador" style="visibility:hidden"
							class="form-control" />
					</div>

					<div class="col-md-6">
						<form:input path="correoAutorizador" id="textCorreo"
							placeholder="Correo" style="visibility:hidden"
							class="form-control" />
					</div>
				</div>
			</div>
			...
			<div class="col-sm-6 col-lg-4 celda columna1" id="altura4">
				<div class="form-group">
					...
					<form:label path="requiereParada"
						class="col-md-5 control-label titulos">
          ¿Requiere parada?
          </form:label>
			...
			<div class="col-sm-6 col-lg-3 celda columna1" id="altura4">
				<div class="form-group">
					...
					<div class="col-md-12">
						<form:input class="form-control" type="text" path="relaseNotes"
			...
			<div class="col-sm-6 col-lg-5 celda columna1" id="altura3">
				<div class="form-group ">
					<div class="col-md-12">
						<input name="archivos[0]" type="file"> <input
							name="archivos[1]" type="file">


						<c:if test="${not empty ficheros}">
							<c:forEach items="${ficheros}" var="fichero">
                                            nombre archivo => ${fichero} <a
									href="borrar/${fichero}">borrar</a>
								<br>
							</c:forEach>
			...
			<div class="col-sm-6 col-lg-7 celda2 columna1">
				...
				<div class="form-group celda2">
					...
					<div class="col-md-9">
						<form:textarea id="asunto" path="asunto"
							placeholder="Asunto del correo." class="form-control" rows="1" />
					</div>
				</div>
			...
			<div class="col-sm-6 col-lg-12 celda columna1">
				...
				<div class="form-group celda">
					<form:label path="correosAnadidos"
						class="col-md-2 control-label titulos" id="divCorreos">Añadir Correos:</form:label>


					<div class="col-md-10">
						<form:input path="correosAnadidos" id="sizeCorreo"
							placeholder="Añada correos." class="tm-input form-control" />
			...
			<div class="col-sm-6 col-lg-12 celda2 columna1">
				...
				<div class="form-group celda2">
					<form:label path="descripccion"
						class="col-md-2 control-label titulos">Descripción:</form:label>
					<div class="col-md-10">
						<form:textarea path="descripccion"
							placeholder="Introduzca la descripción." class="form-control"
							rows="4" />
					</div>
				</div>
			...
			<div class="col-sm-6 col-lg-12 celda columna1">
				...
				<div class="form-group celda">
					<form:label path="documentacion"
						class="col-md-2 control-label titulos">Documentación:</form:label>
					<div class="col-md-8">
						<form:textarea path="documentacion"
							placeholder="Introduzca la url de la documentación."
				...
				<div class="form-group celda2">
					...
					<div class="col-md-8">
						<form:textarea path="motivo"
							placeholder="Introduzca el motivo de la solicitud."
			...
			<div class="col-sm-6 col-lg-7 celda columna1">
				...
				<div class="form-group celda">
					<form:label path="descripcionDOC"
						class="col-md-3 control-label titulos">DESCRIPCIÓN DEL CAMBIO:</form:label>
					<div class="col-md-9">
						<form:textarea path="descripcionDOC"
							placeholder="Describe el cambio que ha realizado."
				...
				<div class="form-group">
					...
					<div class="col-md-3" id="borderTop">
						<input type="submit" value="Descargar"
							formaction="descarga?${_csrf.parameterName}=${_csrf.token}"
							class="btn btn-warning">
					</div>

					<div class="col-md-2" id="borderTop">
						<a href="/main/listaUsuario" role="button" class="btn btn-success">SALIR</a>
					</div>
